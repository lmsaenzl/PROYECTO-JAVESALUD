...
--
-- Table structure for table `consulta_radicados`
--

DROP TABLE IF EXISTS `consulta_radicados`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `consulta_radicados` (
  ...
  `num_radicado` int(10) DEFAULT NULL,
  PRIMARY KEY (`id_paciente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `consulta_radicados`
--

LOCK TABLES `consulta_radicados` WRITE;
/*!40000 ALTER TABLE `consulta_radicados` DISABLE KEYS */;
/*!40000 ALTER TABLE `consulta_radicados` ENABLE KEYS */;
UNLOCK TABLES;
